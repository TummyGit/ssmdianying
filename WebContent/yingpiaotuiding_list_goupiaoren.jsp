...
<div class="form-search">
    <form name="form1" id="formSearch" method="get" action="">
        搜索:
        分类：<select data-value="${param.fenlei}" id="fenlei" name="fenlei" class="class_fenlei18">
        ...
        <table width="100%" border="1" class="table table-list table-bordered table-hover">
            ...
            <c:forEach items="${list}" var="map">
                <tr>
                    ...
                    <td><ssm:sql var="mapyingpianfenlei26"
                                 type="find">SELECT fenleimingcheng FROM yingpianfenlei where id=${map.fenlei}</ssm:sql>${mapyingpianfenlei26.fenleimingcheng} </td>
