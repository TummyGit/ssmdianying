...
<h3 class="route-postion">
    <span class="module-name"> 影片分类</span> <span>列表</span>
</h3>

<div class="form-search">
    <form name="form1" id="formSearch" method="get" action="">
        搜索:
                                    分类名称：<input type="text" style="" name="fenleimingcheng" value="${param.fenleimingcheng}" />            
        ...
        <table width="100%" border="1" class="table table-list table-bordered table-hover">
            ...
            <tr>
                ...
                <td align="center">
                                                                        ...
                                                                        <a href="yingpianfenlei_updt.do?id=${map.id}">修改</a>
                        <a href="yingpianfenlei_delete.do?id=${map.id}" onClick="return confirm('真的要删除？')">删除</a>
